...
export const I18N = {
  ko: {
    ...
    emptyPlanDesc: '새 계획을 등록하여 목표를 설정하세요.',
    emptyDoTitle: '모두 완료되었습니다!',
    emptyDoDesc: '계획을 세우면 실행 항목들이 표시됩니다.',
    emptySeeTitle: '분석 데이터 없음',
    emptySeeDesc: '계획을 세우면 분석이 활성화됩니다.',
    ...
    deleteAccountModalTitle: '계정 영구 삭제',
    deleteAccountWarning: '경고: 이 작업은 되돌릴 수 없습니다.',
    deleteAccountDesc: '모든 기록이 영구적으로 삭제됩니다.',
    deleteAccountPrompt: '계속하려면 아래 확인 문구를 입력하세요:',
    deleteAccountConfirmPhrase: '계정을 삭제하겠습니다.',
    ...
    loginBtn: '로그인',
    signupBtn: '회원가입',
    authSubtitle: '계정으로 로그인하거나 새 계정을 생성하세요.',

    // Migration Modal
    migrationModalTitle: '로컬 데이터 마이그레이션',
    migrationModalBody: '기존 로컬(T06) 일기 데이터가 감지되었습니다.<br>현재 계정으로 가져오시겠습니까?',
    migrationModalNotice: '(가져오면 해당 데이터가 서버 계정에 연결됩니다.)',
    migrationSkipBtn: '건너뛰기',
    migrationImportBtn: '내 계정으로 가져오기',
    migrationSuccess: '로컬 데이터가 계정으로 마이그레이션되었습니다.',

    // General UI
    execMemoLabel: '실행 메모 / 참고사항',
    execMemoPlaceholder: '실행 내용에 대한 메모나 참고사항을 적어주세요.',
    historyModalDismissBtn: '닫기',
    clearAllTags: '전체 해제',
    noMemo: '(메모 없음)',
    overrun: '초과',
    executionLogsTitle: '실행 기록 및 메모',
    logSaved: '실행 기록이 저장되었습니다.',
    taskCompletedAndLogSaved: '할 일이 완료되고 실행 기록이 저장되었습니다.',
  ...
  en: {
    ...
    deleteAccountModalTitle: 'Permanent Account Deletion',
    deleteAccountWarning: 'Warning: This action cannot be undone.',
    deleteAccountDesc: 'All records will be permanently deleted.',
    deleteAccountPrompt: 'To proceed, please enter the confirmation phrase below:',
    ...
    loginBtn: 'Login',
    signupBtn: 'Sign Up',
    authSubtitle: 'Please sign in to access your secure diary.',

    // Migration Modal
    migrationModalTitle: 'Local Data Migration',
    migrationModalBody: 'Legacy local (T06) diary data was detected.<br>Would you like to import it into your account?',
    migrationModalNotice: '(Importing will link the data to your account.)',
    migrationSkipBtn: 'Skip',
    migrationImportBtn: 'Import to My Account',
    migrationSuccess: 'Local data migrated to your account successfully.',

    // General UI
    execMemoLabel: 'Execution Memo / Notes',
    execMemoPlaceholder: 'Enter notes or reflections on this execution session.',
    historyModalDismissBtn: 'Close',
    clearAllTags: 'Clear All',
    noMemo: '(No memo)',
    overrun: 'Overrun',
    executionLogsTitle: 'Execution Logs & Memos',
    logSaved: 'Execution log saved.',
    taskCompletedAndLogSaved: 'Task completed and execution log saved.',
